    ...
    `
        <div class="menu-overlay" @click.self="closeMenu">
            <div class="menu-body" @click="">
                ...
                <div class="menu-body">
                    <div class="category-menu-card" :class="{ 'selected-category': isSelected(-1), 'unselected-category': !isSelected(-1) }" @click="selectCategory(-1)">
                    ...
                    <div v-show="!Results">
                        <div class="category-menu-card" :class="{ 'selected-category': isSelected(category.id), 'unselected-category': !isSelected(category.id) }"
